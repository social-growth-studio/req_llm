defmodule ReqLLM.Response.ParserTest do
  ...
  describe "extract_text/1" do
      ...
      response = %Req.Response{
        ...
        body: %{
          "content" => [
            %{
              "type" => "thinking",
              "thinking" => "The user greeted me, so I should respond politely."
            },
            %{"type" => "text", "text" => "Hello world!"}
          ]
        }
    ...
    test "handles error responses" do
      ...
      assert {:error, %ReqLLM.Error.API.Request{}} = Parser.extract_text(response)
    end
  end
  ...
  describe "extract_object/1" do
    ...
    test "handles invalid JSON in response" do
      ...
      assert {:error, %ReqLLM.Error.API.Request{}} = Parser.extract_object(response)
    end
  end
end
