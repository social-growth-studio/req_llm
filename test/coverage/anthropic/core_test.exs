defmodule ReqLLM.Coverage.Anthropic.CoreTest do
  ...
  test "basic completion without system prompt" do
    result = LiveFixture.use_fixture(:anthropic, "basic_completion", fn ->
  ...
  test "completion with system prompt" do
    result = LiveFixture.use_fixture(:anthropic, "system_prompt_completion", fn ->
  ...
  test "temperature parameter" do
    result = LiveFixture.use_fixture(:anthropic, "temperature_test", fn ->
  ...
  test "max_tokens parameter" do
    result = LiveFixture.use_fixture(:anthropic, "max_tokens_test", fn ->
      ReqLLM.generate_text(
        @model,
        "Write a story",
        max_tokens: 5
  ...
  test "string prompt (legacy format)" do
    result = LiveFixture.use_fixture(:anthropic, "string_prompt", fn ->
