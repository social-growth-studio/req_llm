defmodule ReqLLM.Plugins.Kagi do
  @moduledoc """
  ...
  `:req_llm_provider_spec` containing at minimum `%{id: provider_id, auth: auth_spec}`.
  ...
  def add_auth_header(req) do
    case Req.Request.get_private(req, :req_llm_provider_spec) do
