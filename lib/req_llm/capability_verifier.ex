defmodule ReqLLM.CapabilityVerifier do
  @moduledoc """
  ...
  ## Usage
      ...
      ReqLLM.CapabilityVerifier.verify("openai:gpt-4o")
      ReqLLM.CapabilityVerifier.verify("anthropic:claude-3-sonnet", timeout: 30_000)
  ...
  # Auto-discover all capability modules implementing the ReqLLM.Capability behaviour
  defp get_all_capability_modules do
    # For now, return known modules. In the future, this could discover modules automatically
    # using :code.all_loaded() and checking for @behaviour ReqLLM.Capability
    [
      ReqLLM.Capabilities.GenerateText,
      ReqLLM.Capabilities.StreamText,
      ReqLLM.Capabilities.ToolCalling,
      ReqLLM.Capabilities.Reasoning
    ]
  end
  ...
  def run_exunit_tests(capabilities, model, opts) do
    ...
    ExUnit.configure(formatters: [ReqLLM.ExUnit.ModelVerifierFormatter])
