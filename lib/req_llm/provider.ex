defmodule ReqLLM.Provider do
  @moduledoc """
  Simple provider struct for ReqLLM providers.
  ...
  typedstruct do
    ...
    field(:models, %{String.t() => ReqLLM.Model.t()}, default: %{})
  end
  ...
  ## Examples
      ...
      iex> ReqLLM.Provider.new(:anthropic, "Anthropic", "https://api.anthropic.com")
      %ReqLLM.Provider{id: :anthropic, name: "Anthropic", base_url: "https://api.anthropic.com", models: %{}}

  """
  @spec new(atom(), String.t(), String.t(), %{String.t() => ReqLLM.Model.t()}) :: t()
