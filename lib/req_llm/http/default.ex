defmodule ReqLLM.HTTP.Default do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ReqLLM.HTTP.Default.http_pipeline("https://api.openai.com")
      %Req.Request{...}

      iex> ReqLLM.HTTP.Default.http_pipeline("https://api.openai.com", stream?: true)
      %Req.Request{...}

      iex> provider_spec = %{id: :anthropic, auth: {:header, "x-api-key", :plain}}
      iex> ReqLLM.HTTP.Default.http_pipeline("https://api.anthropic.com", provider_spec: provider_spec)
      %Req.Request{...}
  """
