defmodule ReqLLM.Provider.Registry do
  ...
  ## Examples
      ...
      iex> ReqLLM.Provider.Registry.fetch(:nonexistent)
      {:error, :not_found}
  ...
  ## Examples
      ...
      iex> ReqLLM.Provider.Registry.fetch!(:nonexistent)
      ** (ReqLLM.Error.Invalid.Provider) Unknown provider: nonexistent
  ...
  ## Examples
      ...
      iex> providers = ReqLLM.Provider.Registry.list_providers()
