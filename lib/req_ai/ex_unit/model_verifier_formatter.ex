defmodule ReqAI.ExUnit.ModelVerifierFormatter do
  @moduledoc """
  Custom ExUnit formatter for ReqAI model verification that provides clean,
  ...
  def init(_opts) do
    ...
    formatter_opts = Application.get_env(:req_ai, :formatter_opts, mode: :pretty)
