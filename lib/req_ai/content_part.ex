defmodule ReqAI.ContentPart do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ReqAI.ContentPart.text("Hello, world!")
      %ReqAI.ContentPart{type: :text, text: "Hello, world!"}

      iex> ReqAI.ContentPart.text("Hello, world!", metadata: %{provider_options: %{openai: %{image_detail: "high"}}})
      %ReqAI.ContentPart{type: :text, text: "Hello, world!", metadata: %{provider_options: %{openai: %{image_detail: "high"}}}}
  ...
  ## Examples
      ...
      iex> ReqAI.ContentPart.image_url("https://example.com/image.png")
      %ReqAI.ContentPart{type: :image_url, url: "https://example.com/image.png"}

      iex> ReqAI.ContentPart.image_url("https://example.com/image.png", metadata: %{provider_options: %{openai: %{detail: "high"}}})
      %ReqAI.ContentPart{type: :image_url, url: "https://example.com/image.png", metadata: %{provider_options: %{openai: %{detail: "high"}}}}
  ...
  ## Examples
      ...
      iex> ReqAI.ContentPart.image_data(image_data, "image/png")
      %ReqAI.ContentPart{type: :image, data: <<137, 80, 78, 71>>, media_type: "image/png"}
  ...
  ## Examples
      ...
      iex> ReqAI.ContentPart.file(file_data, "application/pdf", "document.pdf")
      %ReqAI.ContentPart{type: :file, data: <<37, 80, 68, 70>>, media_type: "application/pdf", filename: "document.pdf"}
  ...
  ## Examples
      ...
      iex> ReqAI.ContentPart.tool_call("call_123", "get_weather", %{location: "NYC"})
  ...
  ## Examples
      ...
      iex> ReqAI.ContentPart.tool_result("call_123", "get_weather", %{temperature: 72})
  ...
  ## Examples
      ...
      iex> part = ReqAI.ContentPart.text("Hello")
      iex> ReqAI.ContentPart.valid?(part)
      true

      iex> part = ReqAI.ContentPart.image_url("https://example.com/image.png")
      iex> ReqAI.ContentPart.valid?(part)
      true

      iex> ReqAI.ContentPart.valid?(%{type: :text, text: "Hello"})
      false
  ...
  ## Examples
      ...
      iex> part = ReqAI.ContentPart.text("Hello", metadata: %{provider_options: %{openai: %{image_detail: "high"}}})
      iex> ReqAI.ContentPart.provider_options(part)
  ...
  ## Examples
      ...
      iex> part = ReqAI.ContentPart.text("Hello")
      iex> ReqAI.ContentPart.to_map(part)
