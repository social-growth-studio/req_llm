defmodule ReqAI.Error do
  @moduledoc """
  Error handling system for ReqAI using Splode.
  """

  use Splode,
    error_classes: [
      invalid: ReqAI.Error.Invalid,
      api: ReqAI.Error.API,
      validation: ReqAI.Error.Validation,
      unknown: ReqAI.Error.Unknown,
      object_generation: ReqAI.Error.ObjectGeneration
    ],
    unknown_error: ReqAI.Error.Unknown.Unknown
  ...
  defmodule Validation.Error do
    ...
    @typedoc "Validation error returned by ReqAI"
    @type t() :: %__MODULE__{
            tag: atom(),
            reason: String.t(),
            context: keyword()
  ...
  ## Examples
      ...
      iex> error = ReqAI.Error.validation_error(:invalid_model_spec, "Bad model", model: "test")
      iex> error.tag
      :invalid_model_spec
      iex> error.reason
      "Bad model"
  ...
  """
  @spec validation_error(atom(), String.t(), keyword()) :: ReqAI.Error.Validation.Error.t()
  def validation_error(tag, reason, context \\ []) do
    ReqAI.Error.Validation.Error.exception(tag: tag, reason: reason, context: context)
  end
end
